...
myawesomemenu = {
   ...
   { "bitwarden", function() awful.util.spawn("bitwarden") end },
   { "slack", function() awful.util.spawn("slack") end },
}
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "b", function () awful.spawn("bitwarden") end,
    ...
    awful.key({ modkey,           }, "=", 
        ...
        {description = "decrease the gaps between windows", group = "layout"}),
    awful.key({ modkey,           }, "0", 
        function () 
            local screen = awful.screen.focused()
            local tag = screen.selected_tag
        ...
        {description = "set the gaps between windows to zero", group = "layout"}),
    ...
    -- Menubar
    awful.key({ modkey }, "p", function() awful.spawn("rofi -show run -theme purple") end,
              {description = "show a launcher", group = "launcher"})
)
...
awful.util.spawn("update_volume", false)
awful.util.spawn("update_weather", false)
